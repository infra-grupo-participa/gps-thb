...
/**
 * Falha ao montar a pasta do Drive.
 *
 ...
 */
export default function PastaError({
  error,
  reset,
}: {
  ...
  return (
    <ErroPainel
      titulo="Não foi possível carregar sua pasta"
      descricao="Seus arquivos estão no Drive e não foram afetados. Foi esta tela que não montou."
      digest={error.digest}
    >
