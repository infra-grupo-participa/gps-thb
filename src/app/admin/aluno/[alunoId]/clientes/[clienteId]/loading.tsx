 ...
 * lista sem esperar.
 *
 * `max-w-4xl` é a largura da ficha de verdade — mesma forma da ficha do
 * aluno (`src/app/clientes/[clienteId]/loading.tsx`), replicada aqui porque
 * o Modo Assistência é a mesma tela sob outra rota.
 */
export default function AdminAlunoClienteFichaLoading() {
  return (
    <>
      <HeaderSkeleton />
