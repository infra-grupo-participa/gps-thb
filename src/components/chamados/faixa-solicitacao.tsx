/**
 * A faixa "atual → novo" de uma solicitação de troca (cliente ou sócio).
 * Server Component puro — sem estado, sem action. Aparece no topo da
 * thread, ACIMA das mensagens, nas duas visões (aluno e admin).
 *
    ...
    <div className="grid gap-2 rounded-xl border border-borda-fina bg-superficie-afundada p-3.5">
      <div className="flex flex-wrap items-center gap-2">
        {estado === "pendente" ? (
          ...
          <Badge variant="success">Troca aprovada</Badge>
        ) : (
