...
/**
 * Falha ao montar a lista de chamados.
 *
 ...
 */
export default function ChamadosError({
  error,
  reset,
}: {
  ...
  return (
    <ErroPainel
      titulo="Não foi possível carregar seus chamados"
      descricao="Nenhum chamado foi perdido — a lista é que não veio agora. Tente de novo."
      digest={error.digest}
    >
