...
/**
 * Falha ao montar a aba do Plantão de Dúvidas.
 *
 ...
 */
export default function PlantaoError({
  error,
  reset,
}: {
  ...
  return (
    <ErroPainel
      ...
      descricao="Sua inscrição, se você tiver uma, continua valendo. Foi esta tela que não montou agora."
      digest={error.digest}
    >
